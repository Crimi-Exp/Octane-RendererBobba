...
export class OctaneMessages implements IMessageConfiguration
{
    ...
    private registerComposers(): void
    {
        ...
        this._composers.set(OutgoingHeader.REWARD_TRACK_CLAIM, RewardTrackClaimComposer);
        this._composers.set(OutgoingHeader.REWARD_TRACK_REQUEST, RewardTrackRequestComposer);
